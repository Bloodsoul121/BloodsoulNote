package con.gionee.bloodsoulnote.halfitem;
...
public class HalfItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_half_item);
        mStart = (TextView) findViewById(R.id.half_item_start);
        mEnd = (TextView) findViewById(R.id.half_item_end);
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    convertView = LayoutInflater.from(HalfItemActivity.this).inflate(R.layout.half_item_item, null);
                    holder.tv = (TextView) convertView.findViewById(R.id.half_item_tv);
