...
public class AddBookMarkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.gionee.bloodsoulnote.R.layout.activity_add_book_mark);
        initView();
        initData();
        updateItemUIState();
    ...
    private void initView() {
        ...
        mTitleTx = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.title_tx);
        mUrlTx = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.url_tx);
        mBookmarkTitle = (AmigoEditText) findViewById(com.gionee.bloodsoulnote.R.id.bookmark_title);
        mBookmarkAddress = (EditText) findViewById(com.gionee.bloodsoulnote.R.id.bookmark_address);
        mAddToTx = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.add_to_text);
        mAddBookmark = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.add_bookmark);
        mAddRate = (ImageView) findViewById(com.gionee.bloodsoulnote.R.id.add_rate);
        mAddOnlineApp = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.add_online_app);
        mAddHome = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.add_home);
        mFolderName = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.title_text);
        mChoserFolder = (RelativeLayout) findViewById(com.gionee.bloodsoulnote.R.id.layout_chose_folder);
    ...
    private void changeTitleBarHeight() {
        ...
        if (Configuration.ORIENTATION_LANDSCAPE == getResources().getConfiguration().orientation) {
            params.height = getResources().getDimensionPixelOffset(com.gionee.bloodsoulnote.R.dimen.titilebar_height_landscape);
        } else {
            params.height = getResources().getDimensionPixelOffset(com.gionee.bloodsoulnote.R.dimen.titlebar_double_selection_height);
        }
        mTitleBar.setLayoutParams(params);
    }

    private void initTitleBar() {
        mTitleBar = (RelativeLayout) findViewById(com.gionee.bloodsoulnote.R.id.addbookmark_titlbar);
        mSaveBtn = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.save);
        mSaveBtn.setOnClickListener(mOnClickListener);
        mSaveBtn.setText(com.gionee.bloodsoulnote.R.string.add_bookmark_titlebar_save);

        mDropBtn = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.drop);
        mDropBtn.setOnClickListener(mOnClickListener);
        mDropBtn.setText(com.gionee.bloodsoulnote.R.string.add_bookmark_titlebar_drop);
    }

    private void initData() {
        mBookmarkTitle.setText("title");
        mBookmarkAddress.setText("url");
        mFolderName.setText(getString(com.gionee.bloodsoulnote.R.string.bookmark_parent));
    }
...
//    }
    ...
    private void refreshContent(Configuration newConfig) {
        ...
        if (isChangedLanguage(res.getConfiguration(), newConfig)) {
            ...
            if (null != mAddToTx) {
                mAddToTx.setText(com.gionee.bloodsoulnote.R.string.addbookmark_to);
            }
            if (null != mAddBookmark) {
                mAddBookmark.setText(com.gionee.bloodsoulnote.R.string.add_bookmark);
            }
            if (null != mAddOnlineApp) {
                mAddOnlineApp.setText(com.gionee.bloodsoulnote.R.string.add_online_page);
            }
            if (null != mAddHome) {
                mAddHome.setText(com.gionee.bloodsoulnote.R.string.add_home);
            }
            if (null != mTitleTx) {
                mTitleTx.setText(com.gionee.bloodsoulnote.R.string.bookmark_name);
            }
            if (null != mUrlTx) {
                mUrlTx.setText(com.gionee.bloodsoulnote.R.string.bookmark_address);
            }
        }
    }
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (id) {
                case com.gionee.bloodsoulnote.R.id.layout_chose_folder:
//                    choseFolder();
                    break;
                case com.gionee.bloodsoulnote.R.id.drop:
                    dropBookmark();
                    break;
                case com.gionee.bloodsoulnote.R.id.save:
                    save();
                    break;
                case com.gionee.bloodsoulnote.R.id.add_bookmark:
                    setChoseState(!v.isSelected());
                    handleClickItem(v);
                    break;
                case com.gionee.bloodsoulnote.R.id.add_online_app:
                    handleClickItem(v);
                    break;
                case com.gionee.bloodsoulnote.R.id.add_home:
                    showDeskToast(v);
                    handleClickItem(v);
                    break;
                default:
    ...
    private void showDeskToast(View view) {
        if (!view.isSelected()) {
            Toast.makeText(this, this.getResources().getString(com.gionee.bloodsoulnote.R.string.add_home_prompt), Toast.LENGTH_SHORT).show();
        }
    }
...
//        }
        ...
        if (isUnSelectedItem()) {
            Toast.makeText(this, com.gionee.bloodsoulnote.R.string.bookmark_needs_select, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private boolean checkTitleOrAddressNull() {
        ...
        if (TextUtils.isEmpty(title)) {
            Toast.makeText(this, com.gionee.bloodsoulnote.R.string.bookmark_needs_title, Toast.LENGTH_SHORT).show();
            return true;
        }

        if (TextUtils.isEmpty(address)) {
            Toast.makeText(this, com.gionee.bloodsoulnote.R.string.bookmark_needs_url, Toast.LENGTH_SHORT).show();
            return true;
        }
...
//    }
    ...
    private void showToastMessage() {
        ...
        Toast.makeText(this, com.gionee.bloodsoulnote.R.string.bookmark_add_complete, Toast.LENGTH_SHORT).show();
    }
