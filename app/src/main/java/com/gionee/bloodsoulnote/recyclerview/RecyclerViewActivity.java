package com.gionee.bloodsoulnote.recyclerview;
...
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.gionee.bloodsoulnote.R.layout.activity_recycler_view);
    ...
    private void initBtn() {
        Button btn = (Button) findViewById(com.gionee.bloodsoulnote.R.id.btn);
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder> {
        ...
        public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(RecyclerViewActivity.this).inflate(com.gionee.bloodsoulnote.R.layout.recycler_item2, null);
        ...
        class RecyclerHolder extends RecyclerView.ViewHolder {
            ...
            public RecyclerHolder(View itemView) {
                super(itemView);
                mTextView = (TextView) itemView.findViewById(com.gionee.bloodsoulnote.R.id.tv);
            }
        }
