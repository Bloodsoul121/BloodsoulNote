    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(new RecyclerView.Adapter<RecyclerView.ViewHolder>() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                return new RecyclerView.ViewHolder(LayoutInflater.from(TextViewLinesActivity.this).inflate(R.layout.activity_item_lines, parent, false)) {
                };
            }
...
//                holder.itemView.findViewById(R.id.btn_list_demo).setVisibility(View.GONE);
                final TextView textView = (TextView) holder.itemView.findViewById(R.id.tv);
