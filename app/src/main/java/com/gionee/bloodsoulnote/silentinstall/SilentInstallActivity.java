package com.gionee.bloodsoulnote.silentinstall;
...
public class SilentInstallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.gionee.bloodsoulnote.R.layout.activity_silent_install);
        apkPathText = (TextView) findViewById(com.gionee.bloodsoulnote.R.id.apkPathText);
    }
    ...
    public void onSilentInstall(View view) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final boolean result = installHelper.sysInstall(apkPath);
